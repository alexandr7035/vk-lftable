...
def start_text():
    ...
    text += 'Если вы не видите клавиатуру, вы можете настроить уведомления об обновлении расписания в браузерной версии VK и получать их в любом VK-клиенте (Или воспользоваться версией бота для Telegram — https://t.me/lftable_bot).'
    return(text)
